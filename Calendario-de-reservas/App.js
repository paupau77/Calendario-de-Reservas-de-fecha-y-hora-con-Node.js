...
// Detecta si estamos en localhost o en red local
let backendURL = '';
if (
  window.location.hostname === 'localhost' ||
  window.location.hostname === '127.0.0.1'
) {
  backendURL = 'http://localhost:3000/api/bookings';
} else {
  // Cambia la IP a la de tu PC si accedes desde otro dispositivo
  backendURL = 'http://127.0.0.1:3000/api/bookings';
}
